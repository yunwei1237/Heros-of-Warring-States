...
##为了支持官职系统，让每一个城指定相应的官员
#以下是关于首都的官员,三公和九卿官职都在首都（国王的城镇就是首都）
slot_capital_chengxiang = 210  ##丞相
slot_capital_taiwei = 211 ##太尉
slot_capital_yushidafu = 212 ##御史大夫

slot_capital_fengchang = 213 ##奉常
slot_capital_langzhongling = 214 ##郎中令
slot_capital_weiwei = 215 ##卫尉
slot_capital_taipu = 216 ##太仆
slot_capital_tingwei = 217 ##廷尉
slot_capital_dianke = 218 ##典客
slot_capital_zongzheng = 219 ##宗正
slot_capital_zhilineishi = 220 ##治粟内史
slot_capital_shaofu = 221 ##少府
#以下是关于郡的官员，郡守的官职都在这里
slot_town_junshou = 210 ##郡守
slot_town_jianyushi = 212 ##监御史
slot_town_junwei = 217 ##郡尉
slot_town_juncheng = 220 ##郡丞
#以下是关于县的官员
slot_castle_xianling = 210 ##县令
slot_castle_xiancheng = 220 ##县丞
slot_castle_xianwei = 217 ##县尉
slot_castle_gongcao = 212 ##功曹
slot_castle_lingshi = 211 ##令史
slot_castle_yuchuan = 212 ##狱掾
slot_castle_wenwuhai = 213 ##文无害
slot_castle_jiuzou = 216 ##厩驺
slot_castle_cangli = 214 ##仓吏
slot_castle_zhiyuli = 215 ##治狱吏
#以下是关于亭的官员
slot_village_tingzhang = 210 ##亭长
slot_village_sanlao = 212 ## 三老
slot_village_youjiao = 217 ## 游徼
slot_village_youzhi = 214 ## 有秩
##官职结束
...
##货物的生产率需要保存在城镇中,这个标识代表第一个货物的生产率,206代表第二个货物的生产率
...
slot_troop_home                       = 60##代表游戏中贵族小姐的家乡（原游戏中并没有使用在其它的领主上），现在将这个位置当成一个领主上任的地方，受封官职时会更改
...
##官职系统
decemvirate_begin = "str_chengxiang"
decemvirate_end = "str_end"