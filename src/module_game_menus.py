...
#This needs to be the first window!!!
  (
    ...
    [
      ...
      ("start_mode",[],"Start Mod",
       [
           (troop_set_type,"trp_player",0),
           (assign,"$character_gender",tf_female),
           # (troop_raise_attribute,"trp_player",ca_strength,1),#力量
           # (troop_raise_attribute,"trp_player",ca_agility,1),#敏捷
           # (troop_raise_attribute,"trp_player",ca_charisma,1),#魅力
           # (troop_raise_attribute,"trp_player",ca_intelligence,1),#智力
           (troop_raise_skill,"trp_player",skl_weapon_master,10),
           (troop_raise_skill,"trp_player",skl_power_draw,10),
           #(troop_raise_proficiency_linear,wpt_archery,300),
           #重置玩家金钱
	       (troop_add_gold,"trp_player",10000),
           #给玩家添加装备（骏马和大剑）
	       (troop_add_item,"trp_player","itm_courser"),
	       (troop_add_item,"trp_player","itm_great_sword"),
           (change_screen_return,0),##进入大地图
        ]
       ),
      ("go_back",[],"Go back",
       [(change_screen_quit),
