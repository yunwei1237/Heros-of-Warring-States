  ...
  ("game_start",
   [
      ...
      (troop_set_slot, "trp_player", slot_troop_prisoner_of_party, -1),
       #设置除玩家外其他的全部英雄(主要是为了初始化)
      (try_for_range, ":cur_troop", kingdom_heroes_begin, kingdom_heroes_end),
        (troop_set_slot, ":cur_troop", slot_troop_prisoner_of_party, -1),##不是别人的俘虏
        (troop_set_slot, ":cur_troop", slot_troop_custom_banner_flag_type, -1),##旗帜类型
        (troop_set_slot, ":cur_troop", slot_troop_custom_banner_map_flag_type, -1),##地图旗帜类型
      (try_end),
       #玩家旗帜类型
      ...
      #将这些颜色存放到trp_banner_background_color_array集合中,把一个兵种当成一个数组
...
# Reseting player party icon(重置玩家的信息)，如果要给玩家初始时增加小兵，可以在module_troops.py文件中设置（player兵种）
       #重置旗帜
...
# Setting food bonuses（设置食物的士气奖励）
...
#NPC companion changes begin（初始化16个npc信息）
      (call_script, "script_initialize_npcs"),
       ## 设置npc之间相互争吵（0：争吵，1：不争吵）
      (assign, "$disable_npc_complaints", 0),
#NPC companion changes end



# Setting book intelligence requirements（设置阅读书籍需要的智力）
...
# Setting the random town sequence:（设置随机城镇序列）
       #这段代码的作用就是将城镇的编号打乱顺序保存到数组（trp_random_town_sequence）中
      ...
      (try_for_range, ":unused", 0, ":num_iterations"),
        ...
        #循环数组，判断在数组中是否已经存在，如果存在就说明该城镇已经保存，则重新随机产生城镇编号，
        # 如果没有存在就保存到数组中，然后产生下一个城镇编号，直到所有的城镇编号都唯一地保存在数组中
        (assign, ":is_unique", 1),
...
# Cultures:
	  ...
	  ##新增
	  (faction_set_slot, "fac_culture_6",  slot_faction_tier_1_troop, "trp_han_recruit"),
      (faction_set_slot, "fac_culture_6",  slot_faction_tier_2_troop, "trp_han_militia"),
      (faction_set_slot, "fac_culture_6",  slot_faction_tier_3_troop, "trp_han_footman"),
      (faction_set_slot, "fac_culture_6",  slot_faction_tier_4_troop, "trp_han_infantry"),
      (faction_set_slot, "fac_culture_6",  slot_faction_tier_5_troop, "trp_han_knight"),


      (faction_set_slot, "fac_culture_7", slot_faction_tier_1_troop, "trp_yan_recruit"),
      (faction_set_slot, "fac_culture_7", slot_faction_tier_2_troop, "trp_yan_footman"),
      (faction_set_slot, "fac_culture_7", slot_faction_tier_3_troop, "trp_yan_veteran"),
      (faction_set_slot, "fac_culture_7", slot_faction_tier_4_troop, "trp_yan_infantry"),
      (faction_set_slot, "fac_culture_7", slot_faction_tier_5_troop, "trp_yan_knight"),

      (faction_set_slot, "fac_culture_8", slot_faction_tier_1_troop, "trp_zhou_tribesman"),
      (faction_set_slot, "fac_culture_8", slot_faction_tier_2_troop, "trp_zhou_skirmisher"),
      (faction_set_slot, "fac_culture_8", slot_faction_tier_3_troop, "trp_zhou_horseman"),
      (faction_set_slot, "fac_culture_8", slot_faction_tier_4_troop, "trp_zhou_horse_archer"),
      (faction_set_slot, "fac_culture_8", slot_faction_tier_5_troop, "trp_zhou_veteran_horse_archer"),

      (faction_set_slot, "fac_culture_9", slot_faction_tier_1_troop, "trp_lu_recruit"),
      (faction_set_slot, "fac_culture_9", slot_faction_tier_2_troop, "trp_lu_footman"),
      (faction_set_slot, "fac_culture_9", slot_faction_tier_3_troop, "trp_lu_trained_footman"),
      (faction_set_slot, "fac_culture_9", slot_faction_tier_4_troop, "trp_lu_warrior"),
      (faction_set_slot, "fac_culture_4", slot_faction_tier_5_troop, "trp_lu_veteran"),

      (faction_set_slot, "fac_culture_10", slot_faction_tier_1_troop, "trp_song_tribesman"),
      (faction_set_slot, "fac_culture_10", slot_faction_tier_2_troop, "trp_song_spearman"),
      (faction_set_slot, "fac_culture_10", slot_faction_tier_3_troop, "trp_song_trained_spearman"),
      (faction_set_slot, "fac_culture_10", slot_faction_tier_4_troop, "trp_song_veteran_spearman"),
      (faction_set_slot, "fac_culture_10", slot_faction_tier_5_troop, "trp_song_sergeant"),
	  
	  (faction_set_slot, "fac_culture_11",  slot_faction_tier_1_troop, "trp_cao_recruit"),
      (faction_set_slot, "fac_culture_11",  slot_faction_tier_2_troop, "trp_cao_militia"),
      (faction_set_slot, "fac_culture_11",  slot_faction_tier_3_troop, "trp_cao_footman"),
      (faction_set_slot, "fac_culture_11",  slot_faction_tier_4_troop, "trp_cao_infantry"),
      (faction_set_slot, "fac_culture_11",  slot_faction_tier_5_troop, "trp_cao_knight"),

      (faction_set_slot, "fac_culture_12", slot_faction_tier_1_troop, "trp_zhongshan_recruit"),
      (faction_set_slot, "fac_culture_12", slot_faction_tier_2_troop, "trp_zhongshan_footman"),
      (faction_set_slot, "fac_culture_12", slot_faction_tier_3_troop, "trp_zhongshan_veteran"),
      (faction_set_slot, "fac_culture_12", slot_faction_tier_4_troop, "trp_zhongshan_infantry"),
      (faction_set_slot, "fac_culture_12", slot_faction_tier_5_troop, "trp_zhongshan_knight"),

      (faction_set_slot, "fac_culture_13", slot_faction_tier_1_troop, "trp_shu_tribesman"),
      (faction_set_slot, "fac_culture_13", slot_faction_tier_2_troop, "trp_shu_skirmisher"),
      (faction_set_slot, "fac_culture_13", slot_faction_tier_3_troop, "trp_shu_horseman"),
      (faction_set_slot, "fac_culture_13", slot_faction_tier_4_troop, "trp_shu_horse_archer"),
      (faction_set_slot, "fac_culture_13", slot_faction_tier_5_troop, "trp_shu_veteran_horse_archer"),

      (faction_set_slot, "fac_culture_14", slot_faction_tier_1_troop, "trp_ba_recruit"),
      (faction_set_slot, "fac_culture_14", slot_faction_tier_2_troop, "trp_ba_footman"),
      (faction_set_slot, "fac_culture_14", slot_faction_tier_3_troop, "trp_ba_trained_footman"),
      (faction_set_slot, "fac_culture_14", slot_faction_tier_4_troop, "trp_ba_warrior"),
      (faction_set_slot, "fac_culture_14", slot_faction_tier_5_troop, "trp_ba_veteran"),

      (faction_set_slot, "fac_culture_15", slot_faction_tier_1_troop, "trp_wu_tribesman"),
      (faction_set_slot, "fac_culture_15", slot_faction_tier_2_troop, "trp_wu_spearman"),
      (faction_set_slot, "fac_culture_15", slot_faction_tier_3_troop, "trp_wu_trained_spearman"),
      (faction_set_slot, "fac_culture_15", slot_faction_tier_4_troop, "trp_wu_veteran_spearman"),
      (faction_set_slot, "fac_culture_15", slot_faction_tier_5_troop, "trp_wu_sergeant"),
      
	  (faction_set_slot, "fac_culture_16",  slot_faction_tier_1_troop, "trp_yue_recruit"),
      (faction_set_slot, "fac_culture_16",  slot_faction_tier_2_troop, "trp_yue_militia"),
      (faction_set_slot, "fac_culture_16",  slot_faction_tier_3_troop, "trp_yue_footman"),
      (faction_set_slot, "fac_culture_16",  slot_faction_tier_4_troop, "trp_yue_infantry"),
      (faction_set_slot, "fac_culture_16",  slot_faction_tier_5_troop, "trp_yue_knight"),

       (faction_set_slot, "fac_culture_17", slot_faction_tier_1_troop, "trp_swadian_recruit"),
       (faction_set_slot, "fac_culture_17", slot_faction_tier_2_troop, "trp_swadian_militia"),
       (faction_set_slot, "fac_culture_17", slot_faction_tier_3_troop, "trp_swadian_footman"),
       (faction_set_slot, "fac_culture_17", slot_faction_tier_4_troop, "trp_swadian_infantry"),
       (faction_set_slot, "fac_culture_17", slot_faction_tier_5_troop, "trp_swadian_knight"),

       (faction_set_slot, "fac_culture_18", slot_faction_tier_1_troop, "trp_vaegir_recruit"),
       (faction_set_slot, "fac_culture_18", slot_faction_tier_2_troop, "trp_vaegir_footman"),
       (faction_set_slot, "fac_culture_18", slot_faction_tier_3_troop, "trp_vaegir_veteran"),
       (faction_set_slot, "fac_culture_18", slot_faction_tier_4_troop, "trp_vaegir_infantry"),
       (faction_set_slot, "fac_culture_18", slot_faction_tier_5_troop, "trp_vaegir_knight"),

       (faction_set_slot, "fac_culture_19", slot_faction_tier_1_troop, "trp_khergit_tribesman"),
       (faction_set_slot, "fac_culture_19", slot_faction_tier_2_troop, "trp_khergit_skirmisher"),
       (faction_set_slot, "fac_culture_19", slot_faction_tier_3_troop, "trp_khergit_horseman"),
       (faction_set_slot, "fac_culture_19", slot_faction_tier_4_troop, "trp_khergit_horse_archer"),
       (faction_set_slot, "fac_culture_19", slot_faction_tier_5_troop, "trp_khergit_veteran_horse_archer"),

       (faction_set_slot, "fac_culture_19", slot_faction_tier_1_troop, "trp_nord_recruit"),
       (faction_set_slot, "fac_culture_19", slot_faction_tier_2_troop, "trp_nord_footman"),
       (faction_set_slot, "fac_culture_19", slot_faction_tier_3_troop, "trp_nord_trained_footman"),
       (faction_set_slot, "fac_culture_19", slot_faction_tier_4_troop, "trp_nord_warrior"),
       (faction_set_slot, "fac_culture_19", slot_faction_tier_5_troop, "trp_nord_veteran"),

       (faction_set_slot, "fac_culture_20", slot_faction_tier_1_troop, "trp_rhodok_tribesman"),
       (faction_set_slot, "fac_culture_20", slot_faction_tier_2_troop, "trp_rhodok_spearman"),
       (faction_set_slot, "fac_culture_20", slot_faction_tier_3_troop, "trp_rhodok_trained_spearman"),
       (faction_set_slot, "fac_culture_20", slot_faction_tier_4_troop, "trp_rhodok_veteran_spearman"),
       (faction_set_slot, "fac_culture_20", slot_faction_tier_5_troop, "trp_rhodok_sergeant"),

       (faction_set_slot, "fac_culture_21", slot_faction_tier_1_troop, "trp_han_recruit"),
       (faction_set_slot, "fac_culture_21", slot_faction_tier_2_troop, "trp_han_militia"),
       (faction_set_slot, "fac_culture_21", slot_faction_tier_3_troop, "trp_han_footman"),
       (faction_set_slot, "fac_culture_21", slot_faction_tier_4_troop, "trp_han_infantry"),
       (faction_set_slot, "fac_culture_21", slot_faction_tier_5_troop, "trp_han_knight"),

       (faction_set_slot, "fac_culture_22", slot_faction_tier_1_troop, "trp_yan_recruit"),
       (faction_set_slot, "fac_culture_22", slot_faction_tier_2_troop, "trp_yan_footman"),
       (faction_set_slot, "fac_culture_22", slot_faction_tier_3_troop, "trp_yan_veteran"),
       (faction_set_slot, "fac_culture_22", slot_faction_tier_4_troop, "trp_yan_infantry"),
       (faction_set_slot, "fac_culture_22", slot_faction_tier_5_troop, "trp_yan_knight"),

       (faction_set_slot, "fac_culture_23", slot_faction_tier_1_troop, "trp_zhou_tribesman"),
       (faction_set_slot, "fac_culture_23", slot_faction_tier_2_troop, "trp_zhou_skirmisher"),
       (faction_set_slot, "fac_culture_23", slot_faction_tier_3_troop, "trp_zhou_horseman"),
       (faction_set_slot, "fac_culture_23", slot_faction_tier_4_troop, "trp_zhou_horse_archer"),
       (faction_set_slot, "fac_culture_23", slot_faction_tier_5_troop, "trp_zhou_veteran_horse_archer"),

       (faction_set_slot, "fac_culture_24", slot_faction_tier_1_troop, "trp_lu_recruit"),
       (faction_set_slot, "fac_culture_24", slot_faction_tier_2_troop, "trp_lu_footman"),
       (faction_set_slot, "fac_culture_24", slot_faction_tier_3_troop, "trp_lu_trained_footman"),
       (faction_set_slot, "fac_culture_24", slot_faction_tier_4_troop, "trp_lu_warrior"),
       (faction_set_slot, "fac_culture_24", slot_faction_tier_5_troop, "trp_lu_veteran"),

       (faction_set_slot, "fac_culture_25", slot_faction_tier_1_troop, "trp_song_tribesman"),
       (faction_set_slot, "fac_culture_25", slot_faction_tier_2_troop, "trp_song_spearman"),
       (faction_set_slot, "fac_culture_25", slot_faction_tier_3_troop, "trp_song_trained_spearman"),
       (faction_set_slot, "fac_culture_25", slot_faction_tier_4_troop, "trp_song_veteran_spearman"),
       (faction_set_slot, "fac_culture_25", slot_faction_tier_5_troop, "trp_song_sergeant"),

       (faction_set_slot, "fac_culture_26", slot_faction_tier_1_troop, "trp_cao_recruit"),
       (faction_set_slot, "fac_culture_26", slot_faction_tier_2_troop, "trp_cao_militia"),
       (faction_set_slot, "fac_culture_26", slot_faction_tier_3_troop, "trp_cao_footman"),
       (faction_set_slot, "fac_culture_26", slot_faction_tier_4_troop, "trp_cao_infantry"),
       (faction_set_slot, "fac_culture_26", slot_faction_tier_5_troop, "trp_cao_knight"),

       (faction_set_slot, "fac_culture_27", slot_faction_tier_1_troop, "trp_zhongshan_recruit"),
       (faction_set_slot, "fac_culture_27", slot_faction_tier_2_troop, "trp_zhongshan_footman"),
       (faction_set_slot, "fac_culture_27", slot_faction_tier_3_troop, "trp_zhongshan_veteran"),
       (faction_set_slot, "fac_culture_27", slot_faction_tier_4_troop, "trp_zhongshan_infantry"),
       (faction_set_slot, "fac_culture_27", slot_faction_tier_5_troop, "trp_zhongshan_knight"),

       (faction_set_slot, "fac_culture_28", slot_faction_tier_1_troop, "trp_shu_tribesman"),
       (faction_set_slot, "fac_culture_28", slot_faction_tier_2_troop, "trp_shu_skirmisher"),
       (faction_set_slot, "fac_culture_28", slot_faction_tier_3_troop, "trp_shu_horseman"),
       (faction_set_slot, "fac_culture_28", slot_faction_tier_4_troop, "trp_shu_horse_archer"),
       (faction_set_slot, "fac_culture_28", slot_faction_tier_5_troop, "trp_shu_veteran_horse_archer"),

# Factions:
       #为每一个国家指定：国王，文化
       (store_sub,":numKingdom","fac_kingdoms_end","fac_kingdom_1"),
       (try_for_range, ":i", 0, ":numKingdom"),
            (store_add, ":kingdom", "fac_kingdom_1",":i"),
            (store_add, ":culture", "fac_culture_1",":i"),
            (store_add, ":king", "trp_kingdom_1_lord",":i"),
...
##      (call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_3", "fac_kingdom_5"),
      ...
      (try_for_range, ":faction_no", kingdoms_begin, kingdoms_end),
        ...
        (else_try),
          ...
          (faction_set_slot, ":faction_no", slot_faction_deserter_troop, "trp_lu_deserter"),
          (faction_set_slot, ":faction_no", slot_faction_guard_troop, "trp_lu_warrior"),
          (faction_set_slot, ":faction_no", slot_faction_messenger_troop, "trp_lu_messenger"),
          (faction_set_slot, ":faction_no", slot_faction_prison_guard_troop, "trp_lu_prison_guard"),
          (faction_set_slot, ":faction_no", slot_faction_castle_guard_troop, "trp_lu_castle_guard"),
        ...
        (else_try),
          ...
          (faction_set_slot, ":faction_no", slot_faction_deserter_troop, "trp_song_deserter"),
          (faction_set_slot, ":faction_no", slot_faction_guard_troop, "trp_song_veteran_spearman"),
          (faction_set_slot, ":faction_no", slot_faction_messenger_troop, "trp_song_messenger"),
          (faction_set_slot, ":faction_no", slot_faction_prison_guard_troop, "trp_song_prison_guard"),
          (faction_set_slot, ":faction_no", slot_faction_castle_guard_troop, "trp_song_castle_guard"),
		...
		(else_try),
          ...
          (faction_set_slot, ":faction_no",  slot_faction_deserter_troop, "trp_cao_deserter"),
          (faction_set_slot, ":faction_no",  slot_faction_guard_troop, "trp_cao_sergeant"),
          (faction_set_slot, ":faction_no",  slot_faction_messenger_troop, "trp_cao_messenger"),
          (faction_set_slot, ":faction_no",  slot_faction_prison_guard_troop, "trp_cao_prison_guard"),
          (faction_set_slot, ":faction_no",  slot_faction_castle_guard_troop, "trp_cao_castle_guard"),
        ...
        (else_try),
          ...
          (faction_set_slot, ":faction_no", slot_faction_deserter_troop, "trp_zhongshan_deserter"),
          (faction_set_slot, ":faction_no", slot_faction_guard_troop, "trp_zhongshan_guard"),
          (faction_set_slot, ":faction_no", slot_faction_messenger_troop, "trp_zhongshan_messenger"),
          (faction_set_slot, ":faction_no", slot_faction_prison_guard_troop, "trp_zhongshan_prison_guard"),
          (faction_set_slot, ":faction_no", slot_faction_castle_guard_troop, "trp_zhongshan_castle_guard"),
        ...
        (else_try),
          ...
          (faction_set_slot, ":faction_no", slot_faction_deserter_troop, "trp_shu_deserter"),
          (faction_set_slot, ":faction_no", slot_faction_guard_troop, "trp_shu_horseman"),
          (faction_set_slot, ":faction_no", slot_faction_messenger_troop, "trp_shu_messenger"),
          (faction_set_slot, ":faction_no", slot_faction_prison_guard_troop, "trp_shu_prison_guard"),
          (faction_set_slot, ":faction_no", slot_faction_castle_guard_troop, "trp_shu_castle_guard"),
        ...
        (else_try),
          ...
          (faction_set_slot, ":faction_no", slot_faction_deserter_troop, "trp_ba_deserter"),
          (faction_set_slot, ":faction_no", slot_faction_guard_troop, "trp_ba_warrior"),
          (faction_set_slot, ":faction_no", slot_faction_messenger_troop, "trp_ba_messenger"),
          (faction_set_slot, ":faction_no", slot_faction_prison_guard_troop, "trp_ba_prison_guard"),
          (faction_set_slot, ":faction_no", slot_faction_castle_guard_troop, "trp_ba_castle_guard"),
        ...
        (else_try),
          ...
          (faction_set_slot, ":faction_no", slot_faction_deserter_troop, "trp_wu_deserter"),
          (faction_set_slot, ":faction_no", slot_faction_guard_troop, "trp_wu_veteran_spearman"),
          (faction_set_slot, ":faction_no", slot_faction_messenger_troop, "trp_wu_messenger"),
          (faction_set_slot, ":faction_no", slot_faction_prison_guard_troop, "trp_wu_prison_guard"),
          (faction_set_slot, ":faction_no", slot_faction_castle_guard_troop, "trp_wu_castle_guard"),
		...
		(else_try),
          ...
          (faction_set_slot, ":faction_no",  slot_faction_deserter_troop, "trp_yue_deserter"),
          (faction_set_slot, ":faction_no",  slot_faction_guard_troop, "trp_yue_sergeant"),
          (faction_set_slot, ":faction_no",  slot_faction_messenger_troop, "trp_yue_messenger"),
          (faction_set_slot, ":faction_no",  slot_faction_prison_guard_troop, "trp_yue_prison_guard"),
          (faction_set_slot, ":faction_no",  slot_faction_castle_guard_troop, "trp_yue_castle_guard"),
...
##        (party_set_slot, "p_four_ways_inn", ":offset", average_price_factor),
	  ...
	  (call_script, "script_set_trade_route_between_centers", "p_town_25", "p_town_26"),
      ...
      (party_set_slot,"p_town_19", slot_town_arena_melee_1_team_size,   1),
      (party_set_slot,"p_town_19", slot_town_arena_melee_2_num_teams,   4),
      (party_set_slot,"p_town_19", slot_town_arena_melee_2_team_size,   1),
      (party_set_slot,"p_town_19", slot_town_arena_melee_3_num_teams,   4),
      (party_set_slot,"p_town_19", slot_town_arena_melee_3_team_size,   1),
      (call_script, "script_center_change_trade_good_production", "p_town_19", "itm_linen", 110, 0),

      (party_set_slot,"p_town_20", slot_town_arena_melee_1_num_teams,   4),
      (party_set_slot,"p_town_20", slot_town_arena_melee_1_team_size,   4),
      (party_set_slot,"p_town_20", slot_town_arena_melee_2_num_teams,   4),
      (party_set_slot,"p_town_20", slot_town_arena_melee_2_team_size,   6),
      (party_set_slot,"p_town_20", slot_town_arena_melee_3_num_teams,   4),
      (party_set_slot,"p_town_20", slot_town_arena_melee_3_team_size,   8),
      (call_script, "script_center_change_trade_good_production", "p_town_20", "itm_smoked_fish", 130, 0),
      
      (party_set_slot,"p_town_21", slot_town_arena_melee_1_num_teams,   2),
      (party_set_slot,"p_town_21", slot_town_arena_melee_1_team_size,   8),
      (party_set_slot,"p_town_21", slot_town_arena_melee_2_num_teams,   2),
      (party_set_slot,"p_town_21", slot_town_arena_melee_2_team_size,   8),
      (party_set_slot,"p_town_21", slot_town_arena_melee_3_num_teams,   2),
      (party_set_slot,"p_town_21", slot_town_arena_melee_3_team_size,   8),
      (call_script, "script_center_change_trade_good_production", "p_town_21", "itm_wine", 120, 0),

      (party_set_slot,"p_town_22", slot_town_arena_melee_1_num_teams,   2),
      (party_set_slot,"p_town_22", slot_town_arena_melee_1_team_size,   8),
      (party_set_slot,"p_town_22", slot_town_arena_melee_2_num_teams,   3),
      (party_set_slot,"p_town_22", slot_town_arena_melee_2_team_size,   8),
      (party_set_slot,"p_town_22", slot_town_arena_melee_3_num_teams,   2),
      (party_set_slot,"p_town_22", slot_town_arena_melee_3_team_size,   5),
      (call_script, "script_center_change_trade_good_production", "p_town_22", "itm_oil", 130, 0),
      ...
      (party_set_slot,"p_town_23", slot_town_arena_melee_2_team_size,   5),
      (party_set_slot,"p_town_23", slot_town_arena_melee_3_num_teams,   2),
      (party_set_slot,"p_town_23", slot_town_arena_melee_3_team_size,   8),
      (call_script, "script_center_change_trade_good_production", "p_town_23", "itm_velvet", 80, 0),

      (party_set_slot,"p_town_24", slot_town_arena_melee_1_num_teams,   2),
      (party_set_slot,"p_town_24", slot_town_arena_melee_1_team_size,   4),
      (party_set_slot,"p_town_24", slot_town_arena_melee_2_num_teams,   3),
      (party_set_slot,"p_town_24", slot_town_arena_melee_2_team_size,   4),
      (party_set_slot,"p_town_24", slot_town_arena_melee_3_num_teams,   3),
      (party_set_slot,"p_town_24", slot_town_arena_melee_3_team_size,   6),
      (call_script, "script_center_change_trade_good_production", "p_town_24", "itm_ale", 130, 0),

      (party_set_slot,"p_town_25", slot_town_arena_melee_1_num_teams,   4),
      (party_set_slot,"p_town_25", slot_town_arena_melee_1_team_size,   4),
      (party_set_slot,"p_town_25", slot_town_arena_melee_2_num_teams,   4),
      (party_set_slot,"p_town_25", slot_town_arena_melee_2_team_size,   6),
      (party_set_slot,"p_town_25", slot_town_arena_melee_3_num_teams,   4),
      (party_set_slot,"p_town_25", slot_town_arena_melee_3_team_size,   8),
      (call_script, "script_center_change_trade_good_production", "p_town_25", "itm_grain", 140, 0),
      (call_script, "script_center_change_trade_good_production", "p_town_25", "itm_flour", 110, 0),

      (party_set_slot,"p_town_26", slot_town_arena_melee_1_num_teams,   3),
      (party_set_slot,"p_town_26", slot_town_arena_melee_1_team_size,   1),
      (party_set_slot,"p_town_26", slot_town_arena_melee_2_num_teams,   3),
      (party_set_slot,"p_town_26", slot_town_arena_melee_2_team_size,   3),
      (party_set_slot,"p_town_26", slot_town_arena_melee_3_num_teams,   3),
      (party_set_slot,"p_town_26", slot_town_arena_melee_3_team_size,   7),
      (call_script, "script_center_change_trade_good_production", "p_town_26", "itm_wool", 130, 0),

      (party_set_slot,"p_town_27", slot_town_arena_melee_1_num_teams,   2),
      (party_set_slot,"p_town_27", slot_town_arena_melee_1_team_size,   2),
      (party_set_slot,"p_town_27", slot_town_arena_melee_2_num_teams,   2),
      (party_set_slot,"p_town_27", slot_town_arena_melee_2_team_size,   5),
      (party_set_slot,"p_town_27", slot_town_arena_melee_3_num_teams,   2),
      (party_set_slot,"p_town_27", slot_town_arena_melee_3_team_size,   8),
      (call_script, "script_center_change_trade_good_production", "p_town_27", "itm_furs", 135, 0),
...
# Towns (loop) 用于设置每一个城镇的相关场景，商人，镇长，旅店商人，武器，装备等
      (try_for_range, ":town_no", towns_begin, towns_end),
...
#        (party_set_slot,":town_no", slot_town_seneschal, ":cur_object_no"),
        ...
        (party_set_slot,":town_no", slot_town_center, ":cur_object_no"),#设置大厅
        (store_add, ":cur_object_no", "scn_town_1_castle", ":offset"),
        (party_set_slot,":town_no", slot_town_castle, ":cur_object_no"),#设置围攻场景
        (store_add, ":cur_object_no", "scn_town_1_prison", ":offset"),
        (party_set_slot,":town_no", slot_town_prison, ":cur_object_no"),#设置监狱
        (store_add, ":cur_object_no", "scn_town_1_walls", ":offset"),
        (party_set_slot,":town_no", slot_town_walls, ":cur_object_no"),#设置城墙
        (store_add, ":cur_object_no", "scn_town_1_tavern", ":offset"),
        (party_set_slot,":town_no", slot_town_tavern, ":cur_object_no"),#设置酒馆
        (store_add, ":cur_object_no", "scn_town_1_store", ":offset"),
        (party_set_slot,":town_no", slot_town_store, ":cur_object_no"),#设置商店
        (store_add, ":cur_object_no", "scn_town_1_arena", ":offset"),
        (party_set_slot,":town_no", slot_town_arena, ":cur_object_no"),#设置竞技场
        (store_add, ":cur_object_no", "scn_town_1_alley", ":offset"),
        (party_set_slot,":town_no", slot_town_alley, ":cur_object_no"),#设置街道
        (store_add, ":cur_object_no", "trp_town_1_mayor", ":offset"),
        (party_set_slot,":town_no", slot_town_elder, ":cur_object_no"),#设置市长
        (store_add, ":cur_object_no", "trp_town_1_tavernkeeper", ":offset"),
        (party_set_slot,":town_no", slot_town_tavernkeeper, ":cur_object_no"),#设置酒馆老板
        (store_add, ":cur_object_no", "trp_town_1_weaponsmith", ":offset"),
        (party_set_slot,":town_no", slot_town_weaponsmith, ":cur_object_no"),#设置武器商人
        (store_add, ":cur_object_no", "trp_town_1_armorer", ":offset"),
        (party_set_slot,":town_no", slot_town_armorer, ":cur_object_no"),#设置护具商人
        (store_add, ":cur_object_no", "trp_town_1_merchant", ":offset"),
        (party_set_slot,":town_no", slot_town_merchant, ":cur_object_no"),#设置商店商人
        (store_add, ":cur_object_no", "trp_town_1_horse_merchant", ":offset"),
        (party_set_slot,":town_no", slot_town_horse_merchant, ":cur_object_no"),#设置马匹商人
        (store_add, ":cur_object_no", "scn_town_1_center", ":offset"),
        #(party_set_slot,":town_no", slot_town_center, ":cur_object_no"),##应该是重复了,可以删掉
        ##设置监狱的门卫的队伍模板
        (party_set_slot,":town_no", slot_town_reinforcement_party_template, "pt_center_reinforcements"),
      (try_end),

# Castles  ##设置城堡的场景，围攻，内部（大厅），监狱
...
#        (party_set_slot,":castle_no", slot_town_seneschal, ":senechal_troop_no"),
        ...
        (party_set_slot,":castle_no", slot_castle_exterior, ":exterior_scene_no"),#设置大厅
        (store_add, ":interior_scene_no", "scn_castle_1_interior", ":offset"),
        (party_set_slot,":castle_no", slot_town_castle, ":interior_scene_no"),#设置围攻场景
        (store_add, ":interior_scene_no", "scn_castle_1_prison", ":offset"),
        (party_set_slot,":castle_no", slot_town_prison, ":interior_scene_no"),#设置监狱
        ##设置监狱的门卫的队伍模板
...
#      (try_end),
      ...
      (try_for_range, ":center_no", centers_begin, centers_end),
        ...
        #Assigning random prosperity 设置随机的繁荣
...
# We assume there are enough banners for all kingdom heroes.
      ...
      (try_for_range, ":kingdom_hero", kingdom_heroes_begin, kingdom_heroes_end),
        ...
        (else_try),
		  ...
		  ##设置旗子，如果超过就循环使用,暂时使用这种方式解决旗子不足的问题
		  (store_sub,":count",banner_scene_props_end_minus_one,banner_scene_props_begin),
		  (val_add,":count",1),
		  (val_mod,":banner_id",":count"),
        ...
        (val_div, ":renown", 2),
        (try_begin),
		  ##在设置时发现是国王就设置忠诚度为100，荣誉在250与400之间随机一个
        ...
        (else_try),
		  ##如果是非国王的领主就随机50-100之间的忠诚，荣誉在100到100之间随机一个
...
#Correcting banners according to the player banner
	  ...
	  ##以下新增阵营的城堡
	  # (call_script, "script_give_center_to_lord", "p_town_11",  "trp_kingdom_6_lord", 0),
      # (call_script, "script_give_center_to_lord", "p_town_17",  "trp_kingdom_7_lord", 0),
      # (call_script, "script_give_center_to_lord", "p_town_19",  "trp_kingdom_8_lord", 0),
	  (call_script, "script_give_center_to_lord", "p_town_20", "trp_kingdom_9_lord", 0),
      (call_script, "script_give_center_to_lord", "p_town_21", "trp_kingdom_10_lord", 0),
      (call_script, "script_give_center_to_lord", "p_town_22", "trp_kingdom_11_lord", 0),
      (call_script, "script_give_center_to_lord", "p_town_23", "trp_kingdom_12_lord", 0),
	  (call_script, "script_give_center_to_lord", "p_town_24", "trp_kingdom_13_lord", 0),
      (call_script, "script_give_center_to_lord", "p_town_25", "trp_kingdom_14_lord", 0),
      (call_script, "script_give_center_to_lord", "p_town_26", "trp_kingdom_15_lord", 0),
      (call_script, "script_give_center_to_lord", "p_town_27", "trp_kingdom_16_lord", 0),

      (call_script, "script_give_center_to_lord", "p_town_28", "trp_kingdom_24_lord", 0),
      (call_script, "script_give_center_to_lord", "p_town_29", "trp_kingdom_25_lord", 0),
      (call_script, "script_give_center_to_lord", "p_town_30", "trp_kingdom_26_lord", 0),
      (call_script, "script_give_center_to_lord", "p_town_31", "trp_kingdom_27_lord", 0),
      (call_script, "script_give_center_to_lord", "p_town_32", "trp_kingdom_28_lord", 0),
      ...
      # (call_script, "script_give_center_to_faction_aux", "p_castle_42", "fac_kingdom_8"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_45", "fac_kingdom_10"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_46", "fac_kingdom_10"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_49", "fac_kingdom_14"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_50", "fac_kingdom_14"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_51", "fac_kingdom_14"),

      (call_script, "script_give_center_to_faction_aux", "p_castle_52", "fac_kingdom_15"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_53", "fac_kingdom_15"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_54", "fac_kingdom_15"),
...
#NPC companion changes end
  ...
  ("update_party_creation_random_limits",
    [
      ...
      #将计算的结果进行设置，最小数量为0，最大数量就是计算得到的结果（无论玩家等级多高，最多也就是100）
      (set_party_creation_random_limits, 0, ":upper_limit"),
      #将计算的结果保存到寄存器reg0中,以便能够在其它地方用得到
  ...
  # param1: center_no 城镇
  # param2: item_id 货物
  # param3: production_rate (should be between -100 (for net consumption) and 100 (for net production) 基本的生产率 -100代表该货物缺少，不够用，0代表产出的货物都用完了，100代表除了正常使用的以外还剩很多货物
  # param4: randomness (between 0-100) 要进行增加或减少的生产率
...
##      (val_add, "$player_honor", ":honor_dif"),
  ...
  ("randomly_start_war_peace",
    [
      ...
      #计算公式：全国平均资源值=（第一个国家平均资源值 + 第二个国家平均资源值 + …… + 最后一个国家平均资源值）/ 所有激活的国家数量
      # 平均资源值公式：每一个国家平均资源值 =（城镇数量*2+城堡数量）/ 军队数量
 ...
 ##         (neq, ":cur_kingdom", "fac_player_supporters_faction"),
          ...
          (try_begin),
            (lt, ":cur_relation", 0), #AT WAR（正在交战）
            #计算和平的机率 和平机率=全部敌对国家的数量*50*100/最大的资源值
            ...
            (try_begin),
              ...
              (assign, ":continue", 1),
              (try_begin),
                #如果正在执行任务：qst_persuade_lords_to_make_peace（劝说领主和平）
              ...
              (try_end),
            (try_end),
          (else_try), # AT PEACE（处于和平期间）
            #数字6【应该】代表的是navtive这个剧本一共有6个国家（包括玩家）
            #chance_to_declare_war = 6/全部交战数量*50*最大资源值/100
            ...
            (try_begin),
              ...
              (assign, ":continue", 1),
              (try_begin),
                #如果玩家正在执行任务：qst_raid_caravan_to_start_war，并且当前国家或下一个国家与该任务有关，国家就不交战
                ...
                (assign, ":continue", 0), #Do not declare war if the quest is active for the specific kingdoms
              (try_end),
              #如果玩家没有执行任务：qst_raid_caravan_to_start_war，两个国家进入交战
              (eq, ":continue", 1),
...
#         (troop_get_slot, ":relation", ":troop_no", slot_troop_player_relation),
	   ...
	   ##用于显示官职内容
	   ##获得当前兵种的官职
	   (troop_get_slot,":gzid",":troop_no",slot_troop_occupation),
	   (str_store_string,s35,":gzid"),
	   ##如果有官职就显示官职名称，否则就显示none
       (add_troop_note_from_sreg, ":troop_no", 0, "@{reg6?:{reg4?{s54} is the ruler of {s56}.^:{s54} is a vassal of {s55} of {s56}.^{s35?[gz{s35}]:@none^}}}Renown: {reg5}.^{reg9?{reg3?She:He} is the {reg3?lady:lord} of {s58}.:{reg3?She:He} has no fiefs.}{s59}", 0),
       (add_troop_note_tableau_mesh, ":troop_no", "tableau_troop_note_mesh"),
     (try_end),
     ]),
...
##显示所有的官职
#script_display_decemvirates
#Input:none
#Output:none
("display_decemvirates",
  [
	(try_for_range,":dv",decemvirate_begin,decemvirate_end),
		(display_message,":dv"),
	(try_end),
  ]),
##将官员分配到管辖区
#script_send_troop_to_home
#Input:none
#Output:none
("send_troop_to_home",
  [
	(try_for_range,":hero",kingdom_heroes_begin,kingdom_heroes_end),
		##获得领主的封地（如果有多个就选择其中一个）
		
		(troop_get_slot,":home",":hero",slot_troop_home),
		(troop_get_slot,":cur_home",":hero",slot_troop_cur_center),
		
		(try_begin),
			(eq,":home",0),##如果该领主没有家
			(store_troop_faction,":faction",":hero"),##获得这个领主的国家
			(faction_get_slot,":king",":faction",slot_faction_leader),##获这个国家的国王
			(troop_get_slot,":capital",":king",slot_troop_home),##获得这个国王的一个城市
			(troop_set_slot,":hero",slot_troop_home,":capital"),##将这个城市设置为该领主的家
			(str_store_troop_name,s16,":hero"),
			(str_store_party_name,s17,":capital"),
			(str_store_faction_name,s18,":faction"),
			(str_store_troop_name,s19,":king"),
			(str_store_troop_name,s20,":cur_home"),
			(display_message,"@{s16} home {s17},cur center is :{s20},his faction is {s18},his king is {s19}"),
		(try_end),
	(try_end),
  ]),
##分配官职
#script_grant_decemvirates
#Input:none
#Output:none
("grant_decemvirates",
  [
	(try_for_range,":center",centers_begin,centers_end),
		...
		(try_begin),
			(neg|eq,":lord",-1),##确保该领地是有主人的
			(store_troop_faction,":faction",":lord"),##获得这个领主的国家
			(str_store_faction_name,s15,":faction"),##保存这个国家的名称
			(display_message,s15),
			(try_begin),
				(neg|troop_slot_eq,":faction",slot_faction_leader,":lord"),##如果这个领主不是国王的话，就可以开始封官了
				(try_for_parties,":party"),##遍历所有的部队
					(try_begin),
						(party_is_active,":party"),##判断当前队伍是否活动的
						(party_stack_get_troop_id,":hero",":party",0),##获得一个部队第一个位置上的兵种
						(troop_is_hero,":hero"),##判断当前兵种是不是一个英雄
						(troop_slot_eq,":hero",slot_troop_home,":center"),##如果当前的领主的办公地是这个城池的话
						(str_store_troop_name_link,s17,":hero"),##获得这个领主的名称
						(try_begin),
							(party_slot_eq,":center",slot_party_type,spt_town),##如果当前的地区是一个城镇
							(try_begin),
								(eq,":hero",":lord"),##如果当前城镇归当前的领主
								(party_set_slot,":center",slot_capital_chengxiang,":hero"),##设置当前城镇的丞相为这个领主
								(str_store_string,s16,"str_chengxiang"),##获得这丞相的名称
								(troop_set_slot,":hero",slot_troop_occupation,slot_capital_chengxiang),##将领主的职业设置为《丞相》
							(else_try),
							
							(try_end),
						(else_try),
							(party_slot_eq,":center",slot_party_type,spt_castle),##如果当前的地区是一个城堡
							(try_begin),
								(eq,":hero",":lord"),##如果当前城堡归当前的领主
								(party_set_slot,":center",slot_castle_xianling,":hero"),
								(str_store_string,s16,"str_xianling"),
								(troop_set_slot,":hero",slot_troop_occupation,slot_castle_xianling),##将领主的职业设置为《县令》
							(else_try),
							
							(try_end),
						(else_try),
							(party_slot_eq,":center",slot_party_type,spt_village),##如果当前的地区是一个村庄
							(try_begin),
								(eq,":hero",":lord"),##如果当前村庄归当前的领主
								(party_set_slot,":center",slot_village_tingzhang,":hero"),
								(str_store_string,s16,"str_tingzhang"),
								(troop_set_slot,":hero",slot_troop_occupation,slot_village_tingzhang),##将领主的职业设置为《亭长》
							(else_try),
								(party_set_slot,":center",slot_village_youjiao,":hero"),
								(str_store_string,s16,"str_youjiao"),
								(troop_set_slot,":hero",slot_troop_occupation,slot_village_youjiao),##将领主的职业设置为《游徼》
							(try_end),
						(try_end),
						(str_store_party_name,s18,":center"),
						(party_set_extra_text,":hero","@[{s15}{s18}{s16}]"),##设置部队的显示名称
						(display_message,"@{s17} set to {s15}{s18}{s16}"),##显示设置的信息
					(end_try),
				(try_end),
			(try_end),
		(try_end),
...
##获得当前地区指定的人才,
#script_get_troop_by_skill
#Input:arg1 center_no arg2 maxskill:0 
#Output:arg3 troop_id
("get_troop_by_skill",
  [
	(try_for_range,":hero",kingdom_heroes_begin,kingdom_heroes_end),
		(str_store_troop_name,s16,":hero"),
		(troop_get_slot,":home",":hero",slot_troop_home ),
		(str_store_party_name,s17,":home"),
		(try_begin),
			(neq|eq,":home",0),
			(display_message,"@{s16}'s home is {s17}"),
		(try_end),
	(try_end),
  ]),
##显示英雄的家乡
#script_display_troop_home
#Input:none
#Output:none
("display_troop_home",
  [
...
##显示国家的信息
#script_display_faction_info
#Input:none
#Output:none
("display_faction_info",
  [
    (store_script_param, ":faction", 1),
    (try_begin),
      (gt,":faction",0),
      (str_store_faction_name_link,s1,":faction"),
      #人数
      (assign,":heroNum",0),
      (try_for_range, ":hero", heroes_begin, heroes_end),
          (troop_slot_eq,":hero",slot_troop_occupation,slto_kingdom_hero),
          (store_troop_faction,":curFaction",":hero"),
          (eq,":faction",":curFaction"),
          (val_add,":heroNum",1),
      (end_try),
      #城数
      (assign,":centerNum",0),
      (try_for_range, ":center", centers_begin, centers_end),
          (store_faction_of_party,":centerFaction",":center"),
          (eq,":centerFaction",":faction"),
          (val_add,":centerNum",1),
      (end_try),
      (assign,reg1,":heroNum"),
      (assign,reg2,":centerNum"),
      (display_message,"@faction:{s1}  heroNum:{reg1}  centerNum:{reg2}"),
    (else_try),
        (assign,reg1,":heroNum"),
        (display_message,"@Error party ID :{reg1}"),
    (end_try),
  ]),
##显示地点的信息
#script_display_center_info
#Input:none
#Output:none
("display_center_info",
  [
    ...
    (try_begin),
        ...
        #地点类型
        (try_begin),
            (party_slot_eq,":center",slot_party_type,spt_village),#村庄
            (assign,reg2,3),
        (else_try),
            (try_begin),
                (party_slot_eq,":center",slot_party_type,spt_town),#城镇
                (assign,reg2,1),
            (else_try),
                (party_slot_eq,":center",slot_party_type,spt_castle),#城堡
                (assign,reg2,2),
            (end_try),
            (assign,":total",0),
            (party_get_num_companion_stacks,":stacks",":center"),
            (try_for_range, ":i_stack", 0, ":stacks"),
                (party_stack_get_size,":num",":center",":i_stack"),
                (val_add,":total",":num"),
            (end_try),
            (assign,reg1,":total"),
        (end_try),
        (display_message,"@centerName:{s1}    type(1:town,2:castle,3:village):{reg2}    armies:{reg1}"),
    (end_try),
  ]),
