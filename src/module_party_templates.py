...
#  ("default_reinforcements_c","default_reinforcements_c",0,0,fac_commoners,0,[(trp_hired_blade,1,7),(trp_mercenary,3,10),(trp_caravan_guard,3,15)]),
  ...
  ##新建国家兵种模板
  ("kingdom_6_reinforcements_a", "kingdom_1_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_han_militia,2,6),(trp_han_recruit,4,7)]),
  ("kingdom_6_reinforcements_b", "kingdom_1_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_han_crossbowman,2,6),(trp_han_skirmisher,4,7)]),
  ("kingdom_6_reinforcements_c", "kingdom_1_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_han_man_at_arms,3,6)]),

  ("kingdom_7_reinforcements_a", "kingdom_2_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_yan_footman,2,6),(trp_yan_recruit,4,7)]),
  ("kingdom_7_reinforcements_b", "kingdom_2_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_yan_archer,2,6),(trp_yan_skirmisher,3,5),(trp_yan_footman,1,3)]),
  ("kingdom_7_reinforcements_c", "kingdom_2_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_yan_horseman,3,6)]),

  ("kingdom_8_reinforcements_a", "kingdom_3_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_zhou_skirmisher,2,6),(trp_zhou_tribesman,4,7)]),
  ("kingdom_8_reinforcements_b", "kingdom_3_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_zhou_horse_archer,2,6),(trp_zhou_skirmisher,4,7)]),
  ("kingdom_8_reinforcements_c", "kingdom_3_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_zhou_lancer,3,6)]),

  ("kingdom_9_reinforcements_a", "kingdom_4_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_lu_footman,4,8),(trp_lu_recruit,2,4)]),
  ("kingdom_9_reinforcements_b", "kingdom_4_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_lu_archer,1,3),(trp_lu_huntsman,3,5),(trp_lu_footman,2,5)]),
  ("kingdom_9_reinforcements_c", "kingdom_4_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_lu_warrior,3,6)]),

  ("kingdom_10_reinforcements_a", "kingdom_5_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_song_spearman,3,7),(trp_song_tribesman,3,6)]),
  ("kingdom_10_reinforcements_b", "kingdom_5_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_song_trained_crossbowman,2,6),(trp_song_crossbowman,4,7)]),
  ("kingdom_10_reinforcements_c", "kingdom_5_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_song_sergeant,3,6)]),
  
  ("kingdom_11_reinforcements_a", "kingdom_1_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_cao_militia,2,6),(trp_cao_recruit,4,7)]),
  ("kingdom_11_reinforcements_b", "kingdom_1_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_cao_crossbowman,2,6),(trp_cao_skirmisher,4,7)]),
  ("kingdom_11_reinforcements_c", "kingdom_1_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_cao_man_at_arms,3,6)]),

  ("kingdom_12_reinforcements_a", "kingdom_2_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_zhongshan_footman,2,6),(trp_zhongshan_recruit,4,7)]),
  ("kingdom_12_reinforcements_b", "kingdom_2_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_zhongshan_archer,2,6),(trp_zhongshan_skirmisher,3,5),(trp_zhongshan_footman,1,3)]),
  ("kingdom_12_reinforcements_c", "kingdom_2_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_zhongshan_horseman,3,6)]),

  ("kingdom_13_reinforcements_a", "kingdom_3_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_shu_skirmisher,2,6),(trp_shu_tribesman,4,7)]),
  ("kingdom_13_reinforcements_b", "kingdom_3_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_shu_horse_archer,2,6),(trp_shu_skirmisher,4,7)]),
  ("kingdom_13_reinforcements_c", "kingdom_3_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_shu_lancer,3,6)]),

  ("kingdom_14_reinforcements_a", "kingdom_4_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_ba_footman,4,8),(trp_ba_recruit,2,4)]),
  ("kingdom_14_reinforcements_b", "kingdom_4_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_ba_archer,1,3),(trp_ba_huntsman,3,5),(trp_ba_footman,2,5)]),
  ("kingdom_14_reinforcements_c", "kingdom_4_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_ba_warrior,3,6)]),

  ("kingdom_15_reinforcements_a", "kingdom_5_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_wu_spearman,3,7),(trp_wu_tribesman,3,6)]),
  ("kingdom_15_reinforcements_b", "kingdom_5_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_wu_trained_crossbowman,2,6),(trp_wu_crossbowman,4,7)]),
  ("kingdom_15_reinforcements_c", "kingdom_5_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_wu_sergeant,3,6)]),
  
  ("kingdom_16_reinforcements_a", "kingdom_16_reinforcements_a", 0, 0, fac_commoners, 0, [(trp_yue_militia,2,6),(trp_yue_recruit,4,7)]),
  ("kingdom_16_reinforcements_b", "kingdom_16_reinforcements_b", 0, 0, fac_commoners, 0, [(trp_yue_crossbowman,2,6),(trp_yue_skirmisher,4,7)]),
  ("kingdom_16_reinforcements_c", "kingdom_16_reinforcements_c", 0, 0, fac_commoners, 0, [(trp_yue_man_at_arms,3,6)]),
